...
public class itfOfficeAdapter extends RecyclerView.Adapter<itfOfficeAdapter.RecyclerHolder>{
    private LayoutInflater inflater;
    private List<myModels.itfOffice> contacts;
    private String stat;
    private Context activity;
    private  OnItemClickListener mlistener;
    public itfOfficeAdapter(List<myModels.itfOffice> contacts, Context context, OnItemClickListener listener){
    ...
    public RecyclerHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = inflater.inflate(R.layout.customitfoffice,parent,false);
    ...
    public void onBindViewHolder(RecyclerHolder holder, int position) {
        try {
            ...
            holder.AreaOffice.setText(contact.getAreaOffice() + " Area Office.");
    ...
    class RecyclerHolder extends RecyclerView.ViewHolder{
        ...
        TextView AreaOffice, PhoneNo,State,Email,ContactAdd;
        public RecyclerHolder(View itemView,final OnItemClickListener listener) {
            super(itemView);
            AreaOffice =  itemView.findViewById(R.id.AreaOffice);
